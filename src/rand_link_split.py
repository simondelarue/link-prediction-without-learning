...
# Implementation from https://github.com/pyg-team/pytorch_geometric/discussions/7373

@functional_transform('rand_link_split')
class RandLinkSplit(BaseTransform):
...
# -----------------------------------------------------------------------------
# Seed is added to negative sampling
...
def negative_sampling(
    ...
    if method == 'dense':
        ...
        for _ in range(3):  # Number of tries to sample negative indices.
            rnd = sample(population, sample_size, idx.device, seed)
        ...
        idx = idx.to('cpu')
        for _ in range(3):  # Number of tries to sample negative indices.
            rnd = sample(population, sample_size, device='cpu', seed=seed)
